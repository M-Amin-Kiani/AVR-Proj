...
_0x3:
	.DB  0x6E,0x61,0x62,0x61,0x73,0x68,0x69,0x64
	.DB  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0
	.DB  0x0,0x0,0x0,0x0,0x6B,0x68,0x61,0x73
	.DB  0x74,0x65,0x68,0x20,0x0,0x0,0x0,0x0
	.DB  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 000C       char i = 0 ;  // 8 bits zeroes
; 0000 000D         char st1[20] = {"khasteh "};
; 0000 000E         char st2[20] = {"nabashid"} ;
; 0000 000F         char side = 1 ;
; 0000 0010       //flash char s = 'a';
; 0000 0011       //eeprom char e =  'b';
; 0000 0012       //char c = 't' ; // it sis in ram
...
; 0000 0022 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
...
; 0000 002A PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	OUT  0x12,R30
; 0000 002B 
; 0000 002C // Alphanumeric LCD initialization
; 0000 002D // Connections are specified in the
; 0000 002E // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 002F // RS - PORTA Bit 0
; 0000 0030 // RD - PORTA Bit 1
; 0000 0031 // EN - PORTA Bit 2
; 0000 0032 // D4 - PORTA Bit 4
; 0000 0033 // D5 - PORTA Bit 5
; 0000 0034 // D6 - PORTA Bit 6
; 0000 0035 // D7 - PORTA Bit 7
; 0000 0036 // Characters/line: 16
...
; 0000 003C        lcd_clear();
	CALL _lcd_clear
; 0000 003D        //lcd_putchar(i++);
; 0000 003E //       lcd_gotoxy(i,i%2);
; 0000 003F //       if(i==15)
; 0000 0040 //       {
; 0000 0041 //        side += -1 ;
; 0000 0042 //       }
