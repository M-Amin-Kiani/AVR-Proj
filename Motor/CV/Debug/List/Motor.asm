...
; 0000 0011 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0012 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(15)
	OUT  0x17,R30
; 0000 0013 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
_0x3:
; 0000 0024       {
; 0000 0025       PORTB = 0x01;
	LDI  R30,LOW(1)
	OUT  0x18,R30
; 0000 0026           for ( i = 0 ; i < 4 ;i ++ )
	__GETWRN 16,17,0
_0x7:
	__CPWRN 16,17,4
	BRGE _0x8
